...
Los modelos lineales con quiebre hacer referencia a una relación lineal entre dos variables donde la pendiente cambia en algún punto de la relación, este es el punto de quiebre. Por ejemplo, se sabe que el rendimiento de soja disminuye al atrasar la fecha de siembra; si bien la relación es lineal, el atraso de la fecha de siembra no parece afectar demasiado al rinde en un principio, pero a partir de un momento dado, las pérdidas siguen una tendencia lineal. En casos dónde el punto de quiebre es conocido, el modelo se puede ajustar mediante un modelo de regresión lineal múltiple. Sin embargo, en muchas situaciones, este punto es desconocido y encontrar una estimación de este valor es uno de los problemas de interés. En estas situaciones, el modelo se convierte en un modelo no lineal y trae aparejados diversas compliccacione en su ajuste. A continuación se presentan ejemplos de aplicación de estos modelos en R.  
